...
public function testDebugLevelJson() {
    ...
    validateLogJson(logLines[10], MESSAGE_ERROR_JSON);
    validateLogJson(logLines[11], MESSAGE_WARN_JSON);
    validateLogJson(logLines[12], MESSAGE_INFO_JSON);
    validateLogJson(logLines[13], MESSAGE_DEBUG_JSON);
}
