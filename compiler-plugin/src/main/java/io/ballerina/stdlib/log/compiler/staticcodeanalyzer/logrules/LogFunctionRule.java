...
/**
 * Interface to be implemented by all log function analysis rules.
 */
public interface LogFunctionRule {

    /**
     * Analyze the given log function call and report issues if any.
     *
     * @param context Context information required to analyze the function call
     */
    void analyze(LogFunctionContext context);
     ...
     */
    boolean isApplicable(LogFunctionContext context);
}
