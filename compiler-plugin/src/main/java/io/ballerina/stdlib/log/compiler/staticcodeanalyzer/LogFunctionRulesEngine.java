...
/**
 * Engine to execute log function rules.
 */
public class LogFunctionRulesEngine {

    private final List<LogFunctionRule> rules;

    public LogFunctionRulesEngine() {
        this.rules = new ArrayList<>();
        initializeDefaultRules();
    }

    public void executeRules(LogFunctionContext context) {
        for (LogFunctionRule rule : rules) {
    ...
    public void addRule(LogFunctionRule rule) {
